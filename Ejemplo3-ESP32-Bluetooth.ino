...
#define SERVICE_UUID "eb63378a-4e71-4800-9c7a-8ac04b460567"
#define CONTROL_CHARACTERISTIC_UUID "c48572c3-4ac4-4359-ad60-5b6c1c97f750"
#define LED 26
...
void setup() {
  ...
  BLEDevice::init("LabDigitales2024"); // Initializing the device with its name
